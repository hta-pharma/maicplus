...
* Psuedo patient data from the comparator study. This is not required for the matching process but is needed to derive the relative treatment effects between the internal treatment and comparator treatment.
...
combined_data_tte <- rbind(ipd_matched[,colnames(pseudo_ipd)],
                           pseudo_ipd)
combined_data_tte
```
