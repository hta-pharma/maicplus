...
#' @param surv_target Target survival probability at target_time
#' @param target_time Time point for survival probability (default 48 months)
...
run_single_simulation <- function(params) {
  ...
  base_params <- calibrate_base_params(distribution, median_surv, surv_48m,
                                       target_time = sim_params$max_followup)
